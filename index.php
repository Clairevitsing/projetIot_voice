...
<body>
    ...
    <header>
        <nav>
            <a href="http://localhost/reconnaissance-vocale/home.php" class="title">Voice-Note</a>
            <ul>
                ...
                <li><a href="http://localhost/reconnaissance-vocale/calendar_page/calendar.php">Calendrier</a></li>
            </ul>
