...
if (empty($id)) {
    ...
    if ($save) {
        ...
        if ($save_user_schedule) {
            echo "<script> alert('Event Successfully Saved.'); location.replace('http://localhost/reconnaissance-vocale/calendar_page/calendar.php') </script>";
        } else {
    ...
    if ($save) {
        echo "<script> alert('Event Successfully Updated.'); location.replace('http://localhost/reconnaissance-vocale/calendar_page/calendar.php') </script>";
    } else {
